...
angular.module('movieManiaApp').controller('MovieCtrl', function($scope, $routeParams, $http){
		...
		for(var index in movieList){
			...
			if(movie.id === id){
				...
				.then(function(response){
					$scope.movie.abstract = response.data.Abstract;
					$scope.movie.abstractSource = response.data.Abstract_Source;
				})
